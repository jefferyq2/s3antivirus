...
const FRESHCLAM_WORK_DIR = process.env.FRESHCLAM_WORK_DIR || '/tmp';
const EFS_AVDEFINITION_DIR = `${FRESHCLAM_WORK_DIR}/avdefinitions`;
const TMP_AVDEFINITION_DIR = '/tmp/avdefinitions';
...
const MAX_FILE_SIZE = process.env.MAX_FILE_SIZE || '0';
...
module.exports = {
  ...
  EFS_AVDEFINITION_DIR:         EFS_AVDEFINITION_DIR,
  TMP_AVDEFINITION_DIR:         TMP_AVDEFINITION_DIR,
